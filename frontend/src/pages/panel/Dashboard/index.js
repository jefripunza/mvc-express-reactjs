...
import { lineChartConfig, barChartConfig } from "./ChartDemo"
import { config } from '../../../config';

class Dashboard extends Component {
    componentDidMount() {
        this.props.nowPage(config.routes_frontend.panel.dashboard)
                        ...
                        <div class="app-card-body p-3 p-lg-4">
                            ...
                            <div class="row gx-5 gy-3">
                                ...
                                <div class="col-12 col-lg-3">
                                    <a class="btn app-btn-primary" href="https://themes.3rdwavemedia.com/bootstrap-templates/admin-dashboard/portal-free-bootstrap-admin-dashboard-template-for-developers/"><svg
